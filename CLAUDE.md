<!-- specd:begin schema=1 hash=79c8545a1858a7ccab88bccd0283d570082c60de91f458ced7eafb2ded38f47d -->
# specd agent guide
...
Published maturity and assurance claims come from one registry:
- `platform/linux/amd64`: `proven` (observed 2026-08-01; evidence `release/release-decision.md#supported-platforms`)
- `platform/linux/arm64`: `gated` (observed 2026-08-01; evidence `release/release-decision.md#supported-platforms`)
- `platform/darwin/arm64`: `gated` (observed 2026-08-01; evidence `release/release-decision.md#supported-platforms`)
- `platform/windows/amd64`: `gated` (observed 2026-08-01; evidence `release/release-decision.md#supported-platforms`)
- `profile/default`: `proven` (observed 2026-08-01; evidence `release/release-decision.md#implemented-base-loop`)
- `profile/production`: `experimental` (observed 2026-08-01; evidence `release/release-decision.md#stage-8-status`)
- `guarantee/approval`: `proven` (observed 2026-08-01; evidence `SECURITY.md#what-specd-defends`)
- `guarantee/evidence`: `proven` (observed 2026-08-01; evidence `SECURITY.md#what-specd-defends`)
- `guarantee/scope`: `proven` (observed 2026-08-01; evidence `SECURITY.md#what-specd-defends`)
- `guarantee/atomicity`: `proven` (observed 2026-08-01; evidence `SECURITY.md#what-specd-defends`)
- `guarantee/fail-closed`: `proven` (observed 2026-08-01; evidence `SECURITY.md#what-specd-defends`)
- `guarantee/path-containment`: `proven` (observed 2026-08-01; evidence `SECURITY.md#what-specd-defends`)
- `guarantee/host-assurance`: `advisory` (observed 2026-08-01; evidence `SECURITY.md#what-specd-does-not-defend`)
- `coverage/concurrent-end-to-end`: `unclaimed` (observed 2026-08-01; evidence `release/release-decision.md#known-limitations`)
...
Revoke execution authority and return a change to planning.
